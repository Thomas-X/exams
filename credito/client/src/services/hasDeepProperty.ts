export const hasDeepProperty = (obj: any, propArray: any): any => {
...
export const getData = (requestName: string, props: any) => {
...
export const getErrorMessage = (name: string, props: any) => {
    if (props[name].error) {
