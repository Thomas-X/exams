...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Users_thomaszwarts_gitrepos_examen_proef_examen_node_modules_babel_runtime_regenerator__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Users_thomaszwarts_gitrepos_examen_proef_examen_node_modules_babel_runtime_regenerator___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__Users_thomaszwarts_gitrepos_examen_proef_examen_node_modules_babel_runtime_regenerator__);
...
var Server = function Server() {
    ...
    this.connectToDb = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0__Users_thomaszwarts_gitrepos_examen_proef_examen_node_modules_babel_runtime_regenerator___default.a.mark(function _callee() {
        var db;
        return __WEBPACK_IMPORTED_MODULE_0__Users_thomaszwarts_gitrepos_examen_proef_examen_node_modules_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
            while (1) {
    ...
    this.start = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0__Users_thomaszwarts_gitrepos_examen_proef_examen_node_modules_babel_runtime_regenerator___default.a.mark(function _callee2() {
        var http;
        return __WEBPACK_IMPORTED_MODULE_0__Users_thomaszwarts_gitrepos_examen_proef_examen_node_modules_babel_runtime_regenerator___default.a.wrap(function _callee2$(_context2) {
            while (1) {
...
/* harmony default export */ __webpack_exports__["b"] = (function () {
    ...
    __WEBPACK_IMPORTED_MODULE_1_passport___default.a.use(new __WEBPACK_IMPORTED_MODULE_2_passport_jwt__["Strategy"](options, function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0__Users_thomaszwarts_gitrepos_examen_proef_examen_node_modules_babel_runtime_regenerator___default.a.mark(function _callee(jwtPayload, done) {
            var user;
            return __WEBPACK_IMPORTED_MODULE_0__Users_thomaszwarts_gitrepos_examen_proef_examen_node_modules_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
...
var checkIfValidatorFailed = function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0__Users_thomaszwarts_gitrepos_examen_proef_examen_node_modules_babel_runtime_regenerator___default.a.mark(function _callee(req, res, next) {
        var errors, message;
        return __WEBPACK_IMPORTED_MODULE_0__Users_thomaszwarts_gitrepos_examen_proef_examen_node_modules_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
...
Auth.post('/register', validations, checkIfValidatorFailed, function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0__Users_thomaszwarts_gitrepos_examen_proef_examen_node_modules_babel_runtime_regenerator___default.a.mark(function _callee2(req, res, next) {
...
Auth.post('/login', validations, checkIfValidatorFailed, function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0__Users_thomaszwarts_gitrepos_examen_proef_examen_node_modules_babel_runtime_regenerator___default.a.mark(function _callee3(req, res, next) {
        var _req$body2, username, password1, user;

        return __WEBPACK_IMPORTED_MODULE_0__Users_thomaszwarts_gitrepos_examen_proef_examen_node_modules_babel_runtime_regenerator___default.a.wrap(function _callee3$(_context3) {
            while (1) {
